...
ROOT_DIR = "E:\\Musica\\Depeche Mode"
...
if __name__ == '__main__':
    ...
    fig = px.scatter_3d(chart3d_df, x='energy', y='valence', z='loudness',
                        color='genre', hover_name='song')
    fig.show()
    
    #Genre chart
    fig2 = px.histogram(chart3d_df, x='genre', height=400,barmode='group', title="Generi musicali", color="artist", text_auto=True)
    fig2.show()
